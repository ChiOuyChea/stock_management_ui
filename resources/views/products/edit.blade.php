                    ...
                    <form action="{{ route('products.update', $product['id']) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                value="{{ old('name', $product['name']) }}" required placeholder="e.g., Coca Cola">
                            @error('name')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('price_in') is-invalid @enderror"
                                    name="price_in" value="{{ old('price_in', $product['price_in']) }}" step="0.01"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('price_out') is-invalid @enderror"
                                    name="price_out" value="{{ old('price_out', $product['price_out']) }}" step="0.01"
                                    min="0" required placeholder="0.00">
                                @error('price_out')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('stock') is-invalid @enderror" name="stock"
                                value="{{ old('stock', $product['stock']) }}" min="0" required placeholder="0">
                            @error('stock')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
